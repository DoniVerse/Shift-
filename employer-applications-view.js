...
export async function renderEmployerApplications(targetElement, employerId, options = {}) {
  ...
  try {
    ...
    querySnapshot.forEach(docSnap => {
      ...
      const university = app.studentUniversity || app.universityName || app.university || '';
      const year = app.studentYear || app.yearOfStudy || app.year || '';
      ...
      const workExperience = app.workExperience || [];
      ...
      const linkedIn = app.studentLinkedIn || 'Not provided';
      ...
      html += `
        <div class="application-card" style="border:1px solid #d1d5db; background:#f9fafb; padding:1.5em; margin-bottom:1.5em; border-radius:12px; box-shadow:0 2px 8px rgba(0,0,0,0.04);">
          ...
          <div style="margin-bottom:1em; padding:1em; background:#fff; border-radius:8px;">
            ...
            <div style="margin-bottom:0.3em;"><strong>Student:</strong> <span style="color:#2563eb;">${studentName || 'N/A'}</span></div>
          ...
          <div style="margin-bottom:1em; padding:1em; background:#fff; border-radius:8px;">
            ...
            <div style="background:#f8f9fa; padding:0.5em; border-radius:4px; margin-top:0.3em; font-style:italic; color:#555;">${resumeSummary}</div>
          </div>
          ...
          <div style="margin-bottom:1em; padding:1em; background:#fff; border-radius:8px;">
            ...
            <div style="background:#f8f9fa; padding:0.5em; border-radius:4px; margin-bottom:0.5em; white-space:pre-line; color:#555;">${workExperience.length > 0 ? workExperience.join('\n\n') : 'Not provided'}</div>
          ...
          <div style="margin-bottom:1em; padding:1em; background:#fff; border-radius:8px;">
            ...
            <div style="background:#f8f9fa; padding:0.5em; border-radius:4px; margin-bottom:0.5em; color:#555;">${relevantCourses}</div>
            <div style="margin-bottom:0.3em;"><strong>Academic Achievements:</strong></div>
            <div style="background:#f8f9fa; padding:0.5em; border-radius:4px; color:#555;">${academicAchievements}</div>
          </div>
